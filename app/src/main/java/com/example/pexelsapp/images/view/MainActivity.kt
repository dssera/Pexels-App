...
import com.example.pexelsapp.images.view.fragments.FavoritesFragment
import com.example.pexelsapp.images.view.fragments.HomeFragment
import com.example.pexelsapp.images.viewmodel.ImagesViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imgId = findViewById<ImageView>(R.id.iv_img)
//        val imgId2 = findViewById<ImageView>(R.id.iv_img2)
        val b = findViewById<Button>(R.id.b1)
